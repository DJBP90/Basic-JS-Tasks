/*This section a variable is created and named 'menu' inside of menu is value of 
_courses and inside the courses block, there is 3 more parameters with empty arrays.*/
...
const menu = {
    ...
    /*Here the use of getters & setters */
